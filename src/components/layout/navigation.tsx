...
import { LayoutDashboard, ClipboardList, Settings, PieChart, Home, Menu, LogOut, LogIn } from "lucide-react";
        ...
        <aside className="hidden md:flex flex-col w-64 border-r bg-card/50 backdrop-blur-md h-screen sticky top-0 p-4">
            <div className="flex-1">
                <div className="flex items-center gap-2 mb-8 px-2">
                    ...
                    <div>
                        <div className="text-xl font-bold tracking-tight leading-none">Hadbit</div>
                    </div>
                </div>
                {isLoggedIn && (
        ...
        <div className="md:hidden fixed bottom-6 left-6 z-50">
            <Sheet>
                <SheetTrigger asChild>
                    <Button size="icon" className="h-14 w-14 rounded-full shadow-2xl bg-primary hover:bg-primary/90 transition-transform active:scale-95">
                        <Menu className="h-7 w-7" />
                    </Button>
                </SheetTrigger>
                <SheetContent side="left" className="w-[280px] bg-card/95 backdrop-blur-xl border-r flex flex-col">
                    <SheetHeader className="text-left mb-8">
                        <div className="flex items-center gap-2 px-2">
                            ...
                            <div>
                                <SheetTitle className="text-xl font-bold tracking-tight">Hadbit</SheetTitle>
                                {isLoggedIn && (
